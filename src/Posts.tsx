...
const Posts = (props: any) => {
  ...
  // createEffect(() => {
  //   const classifierEntry = props.classifiers.find((classifierEntry: any) => classifierEntry.id == props.category)
  ...
  return (
    <div>
      ...
      <For each={
        ...
        //   return [...Array.from(processedPostsForSession())].indexOf(theMlText.toString()) == -1
        // })
        // .filter((postItem: any) => {
